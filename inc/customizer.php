...
function businessbuilder_customize_register( $wp_customize ) {
  ...
  $wp_customize->add_setting('businessbuilder_options[info]', array(
    'sanitize_callback' => 'businessbuilder_no_sanitize',
    'type' => 'info_control',
    'capability' => 'edit_theme_options',
    )
  );
  $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'pro_section', array(
    'section' => 'businessbuilder_new',
    'settings' => 'businessbuilder_options[info]',
    'type' => 'textarea',
    'priority' => 109
    ) )
  );   
  ...
  $wp_customize->add_section(
    'businessbuilder_premium',
    array(
      'title' => __('Businessbuilder Premium', 'businessbuilder'),
      'priority' => 9999,
      'description' => __('
    <p>
        <a style="display:block;" href="http://vilhodesign.com/themes/businessbuilder/" target="_blank">
  ...
  $wp_customize->add_setting('businessbuilder_premium[info]', array(
    'sanitize_callback' => 'businessbuilder_no_sanitize',
    'type' => 'info_control',
    'capability' => 'edit_theme_options',
    )
  ...
  $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'premium_section', array(
    'section' => 'businessbuilder_premium',
    'settings' => 'businessbuilder_premium[info]',
    'type' => 'textarea',
    'priority' => 109
    ) )
  );  
...
// Extra styles
function businessbuilder_customizer_stylesheet() {
  
  // Stylesheet
  wp_enqueue_style( 'businessbuilder-customizer-css', get_template_directory_uri().'/css/customizer-styles.css', NULL, NULL, 'all' );
